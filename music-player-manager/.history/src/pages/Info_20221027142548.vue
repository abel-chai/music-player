        ...
        this.$axios({
          ...
          response => {
            if(response.data.type == "success"){
              ...
              console.log(singerCountry)
              for(var i = 0; i < singerCountry.length; i++){
                for(var j = 0; j < this.singerOption.xAxis.data.length; j++){
                  console.log(j)
                  console.log(this.singerOption.series[0].data)
                  console.log(this.singerOption.xAxis.data[j])
                  if(this.singerOption.xAxis.data[j] === singerCountry[i]){
                    console.log('a')
                    console.log(this.singerOption.series[0].data[j])
                    this.singerOption.series.data[j] = response.data.data.singerCountry[i]
                    consloe.log(response.data.data.美国)
                    console.log(this.singerOption.series.data[j])
                    break;
                  }
                }
              }
