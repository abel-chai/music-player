            ...
            { required: true, 
              validator: (rule, value, callback) => {
                  ...
                  callback(new Error('请再次输入姓名'));
                    ...
                    callback(new Error('姓名格式输入错误,只能输入中文字符'));
                  } else {
                    callback();
                  }
               },
————————————————
版权声明：本文为CSDN博主「凡尘007」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/qq_41588991/article/details/127666517
              message: '请输入用户名', 
              trigger: 'blur' }
          ],
          password: [
