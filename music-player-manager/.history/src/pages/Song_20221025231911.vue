    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column label="资源更新" width="120" align="center">
          <template v-slot="scope">
            <el-upload :action="updateSongImg(scope.row.id)" :show-file-list="false" :on-success="handleImgSuccess" :before-upload="beforeImgUpload" ref:"img">
...
<script>
  import {beforeImgUpload, beforeSongUpload} from "../utils/index";
  export default {
    name: 'Song',
    data() {
      return {
