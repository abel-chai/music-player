  ...
  <div>
    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="love" label="收藏" width="90" align="center"></el-table-column>
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        tableData = [{
          id:'1', name:'abel', sex:'男', phone:'123456', email:'123', birthday:'2002-02-21', signature:'测试', location:''
        }]
