        ...
        <el-table-column label="资源更新" width="120" align="center">
          <template slot-scope="scope">
            <el-upload
              ...
              list-type="picture"
            >
              <el-button size="small" type="primary" @click="updateImg(scope.row.id)">更新图片</el-button>
            </el-upload>
          </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        song: {},
        form: {},
        url: "http://localhost:9999/song/avatar/",
        params: {_method: 'put'},
      };
    },
    computed:{
    ...
    methods: {
      ...
      beforeUpload(file) {
        ...
        const isExistFileType = uploadTypes.includes
