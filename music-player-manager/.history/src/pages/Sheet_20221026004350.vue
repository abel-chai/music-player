  ...
  <div>
    <div class="container">
      <div class="handle-box">
        ...
        >批量删除</el-button>
        <el-input v-model="query.name" placeholder="歌单名" class="handle-input mr10"></el-input>
      ...
      >
        ...
        <el-table-column label="内容" width="90" align="center">
          <template v-slot="scope">
            <el-button type="primary" plain @click="goContentPage(scope.row)">歌单内容</el-button>
          </template>
        </el-table-column>
        <el-table-column label="评论" width="90" align="center">
          <template v-slot="scope">
            <el-button type="primary" plain @click="goCommentPage(scope.row)">歌单评论</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog title="添加歌单" :visible.sync="addVisible">
      <el-form label-width="80px" ref="sheet" :model="sheet">
        <el-form-item label="歌单名" prop="name">
          <el-input v-model="sheet.name"></el-input>
        </el-form-item>
        <el-form-item label="歌单介绍" prop="location">
          <el-input v-model="sheet.location"></el-input>
        </el-form-item>
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.tableData = [{
          id:'1', name:'abel', sex:'男', birthday:'2002-02-21', location:'河南', intro:'测试', img:''
        }];
