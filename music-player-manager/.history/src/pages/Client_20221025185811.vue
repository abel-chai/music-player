  ...
  <div>
    <div class="container">
      ...
      >
        ...
        <el-table-column label="头像" width="102" align="center">//没搞懂
        ...
        <el-table-column prop="address" label="地址" width="70" align="center"/>
        ...
        <el-table-column label="收藏" width="90" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              class="blue"
              @click="goCollect(scope.$index, scope.row)"
            >收藏</el-button>
          </template>
        </el-table-column>
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.tableData = [{
          id:'1', name:'abel', sex:'男', phone:'123456', email:'123', birthday:'2002-02-21', signature:'测试', address:'河南'
        }];
