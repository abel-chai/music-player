  ...
  export default {
    ...
    data() {
      return {
        ...
        params: {_method: 'put'},
        headers: {token: "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJmYThlZWIwZWEzNTE0YTQ1YmRlNjllZWYxM2RlNzYzZiIsInN1YiI6IjEiLCJpc3MiOiJzZyIsImlhdCI6MTY2NzY0MTAyMSwiZXhwIjoxNjY3NjQ0NjIxfQ.SJyJKEMq3eSbrt8hc_s6fihqX6br0ct2whhIEEfd64I"}
      };
    },
    computed:{
      ...mapState(['token']),
