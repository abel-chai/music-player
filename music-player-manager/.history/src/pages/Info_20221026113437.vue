<template>
  <div>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <!-- <h3>用户性别比例</h3>
        <el-card class="cav-info" shadow="hover" :body-style="{ padding: '0px' }" id="userVar"></el-card> -->
        <h3>歌曲类型</h3>
      ...
      <el-col :span="12">
        <h3>歌曲类型</h3>
        <el-card class="cav-info-2" shadow="hover" :body-style="{ padding: '0px' }" id="songVar"></el-card>
      </el-col>
    </el-row>
    <!-- <el-row :gutter="20">
      <el-col :span="12">
  ...
  export default{
    ...
    methods:{
      draw(){
        ...
        songVar.setOption(this.userOption);
      }
    },
    mounted(){
      this.draw();
